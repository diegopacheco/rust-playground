...
/// AbscissaCoolApp Configuration
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub struct AbscissaCoolAppConfig {
...
/// use `#[derive(Default)]` on AbscissaCoolAppConfig instead.
impl Default for AbscissaCoolAppConfig {
    fn default() -> Self {
        Self {
