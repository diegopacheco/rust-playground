...
use abscissa_cool_app::config::AbscissaCoolAppConfig;
...
/// Use `AbscissaCoolAppConfig::default()` value if no config or args
#[test]
fn start_no_args() {
...
fn start_with_config_no_args() {
    let mut config = AbscissaCoolAppConfig::default();
